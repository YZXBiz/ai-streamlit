...
class TestMergingAssets:
    ...
    def test_optimized_merged_clusters(self, mock_internal_clusters, mock_external_clusters) -> None:
    ...
    def test_cluster_reassignment(self, mock_internal_assignments, mock_external_assignments) -> None:
