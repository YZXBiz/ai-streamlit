"""Tests for the PandasAI utilities."""
...
def test_initialize_agent_with_api_key(sample_dataframe):
    """Test initializing PandasAI agent with a provided API key."""
    with patch('app.utils.pandasai_utils.OpenAI') as mock_openai, \
         patch('app.utils.pandasai_utils.DataFrame') as mock_dataframe, \
         patch('app.utils.pandasai_utils.Agent') as mock_agent:
...
def test_initialize_agent_without_api_key(sample_dataframe):
    """Test initializing PandasAI agent without providing an API key."""
    ...
    with patch.dict(os.environ, {"OPENAI_API_KEY": "env_api_key"}), \
         patch('app.utils.pandasai_utils.OpenAI') as mock_openai, \
         patch('app.utils.pandasai_utils.DataFrame') as mock_dataframe, \
         patch('app.utils.pandasai_utils.Agent') as mock_agent:
