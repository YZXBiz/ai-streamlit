...
def mock_blob_service():
    ...
    return {"service": mock_service, "container": mock_container, "blob": mock_blob}
...
class TestBlobWriter:
    ...
    def test_missing_connection_string(self, mock_getenv):
        ...
        writer = BlobWriter(
            container_name="test-container", blob_name="test.csv", file_format="csv"
        )
    ...
    def test_missing_container_name(self, mock_getenv):
        ...
        writer = BlobWriter(blob_name="test.csv", file_format="csv")
    ...
    def test_container_name_from_env(self, mock_getenv):
        ...
        with patch("azure.storage.blob.BlobServiceClient.from_connection_string") as mock_from_conn:
            ...
            writer = BlobWriter(
                connection_string="test-connection", blob_name="test.csv", file_format="csv"
            )
