...
class TestBlobReader:
    ...
    def test_blob_reader_mocked(self) -> None:
        ...
        with patch("clustering.shared.io.readers.blob_reader.BlobServiceClient", 
...
class TestSnowflakeReader:
    ...
    def test_snowflake_reader_mocked(self) -> None:
        ...
        with patch("clustering.shared.io.readers.snowflake_reader.snowflake.connector.connect", 
