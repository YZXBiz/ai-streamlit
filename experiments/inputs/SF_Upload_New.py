...
def save_to_csv(data: pd.DataFrame, date_str: Optional[str] = None) -> str:
    """
    ...
    output_path = f"/home/jovyan/fsassortment/store_clustering/data/need_states_mapping_{date_str}_AM.csv"
...
def write_to_snowflake(conn, data: pd.DataFrame, date_str: Optional[str] = None) -> str:
    """
