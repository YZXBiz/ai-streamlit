...
def load_and_clean_data():
    ...
    spent_path = os.path.join(DATA_DIR, 'Urbanicity CVS Drive Times with Demos and competitors_#COMP_DEMO_ALL_07022025.csv')
    ...
    competition_path = os.path.join(DATA_DIR, 'Urbanicity CVS Drive Times with Demos and competitors_#COMP_DEMO_ALL_07022025.csv')
    ...
    placer_path = os.path.join(DATA_DIR, 'placer_store_features_2024_20250211_1420_with_remaining.csv')
